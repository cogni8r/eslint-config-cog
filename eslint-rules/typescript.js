...
module.exports = {
  rules: {
    ...
    '@typescript-eslint/member-ordering': 'off', // It's better to order elements by severity (not by member type).
    ...
    '@typescript-eslint/no-parameter-properties': 'off', // It's very convenient for DI.
    ...
    '@typescript-eslint/prefer-for-of': 'off', // Useless.
    '@typescript-eslint/prefer-function-type': 'off', // It's better to be able to use different approaches to describe types.
